            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < criteria.length; i++) {
                        ...
                        criteria_html += "<tr>";
                        criteria_html += "<td>" + criteria[i].id + "</td>";
        ...
        function FetchData() {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < events.length; i++) {
                        e_event_html += "<tr>";
                        e_event_html += "<td>" + events[i].id + "</td>";
                        ...
                        e_event_html += "<td>" + (events[i].is_start == 'true' ?
                            ...
                            '<span class="badge bg-danger">Not Started</span>') + "</td>";
                        e_event_html +=
                            "<td><div class='btn-group'><a class='btn btn-sm btn-info' href='?page=event&event_id=" + events[i].id + "'><i class='bi bi-eye'></i></a></div></td>";
                        e_event_html += "</tr>";
                    }
