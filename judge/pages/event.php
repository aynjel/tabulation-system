                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center mx-auto">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <button type="button" class="btn btn-success" id="start-event">Start Event</button>
                                    <button type="button" class="btn btn-primary" id="result-event">Event Result</button>
                                </div>
                            </div>
                            ...
                            <div class="tab-content pt-2 h-100" id="borderedTabJustifiedContent">
                                <div class="tab-pane fade show active" id="bordered-justified-contestant" role="tabpanel"
